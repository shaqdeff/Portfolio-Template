...
=======
- Click [here](https://yonathan-portfolio.netlify.app/) to view the live demo.
>>>>>>> Stashed changes
...
- [Download the ZIP file from this location](https://github.com/captain-bubblz/portfolio-yonathan/archive/refs/heads/main.zip) or run the following [git](https://git-scm.com/) command to clone the files to your machine:

```
git clone https://github.com/captain-bubblz/portfolio-yonathan.git
```

- Once the files are on your machine, open the **Portfolio-Yonathan** folder in [Visual Studio Code](https://code.visualstudio.com/download).

```
cd Portfolio-Yonathan && code .
```
...
=======
- GitHub: [@Yonathan Ad](https://github.com/admasuyoni)
- LinkedIn: [Yonathan Ad](https://www.linkedin.com/in/yonathan-admasu-7b23742a9/)
>>>>>>> Stashed changes
